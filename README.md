...
A3) The Phase contrast image has a greater range of intensities. 
...
The file "QBio_image_analysis_assignment" in my repository contains the code for this part of the assignment. 
